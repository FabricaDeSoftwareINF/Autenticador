package br.ufg.inf.fabrica.ldapinfautenticador.imp;


import br.ufg.inf.fabrica.ldapinfautenticador.ILdapAutenticador;
import br.ufg.inf.fabrica.ldapinfautenticador.utils.Utils;
...
public class LdapAutenticador implements ILdapAutenticador {
    ...
    public LdapAutenticador(Properties prop, String login, String senha) throws NamingException{
